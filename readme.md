...
* **Backend API:** [https://hormone-planner.onrender.com](https://hormone-planner.onrender.com)
...
1. **Menstrual (Days 1-5):** Focus on recovery and low-effort administrative tasks.
2. **Follicular (Days 6-13):** Prime time for brainstorming and complex problem-solving.
3. **Ovulatory (Days 14-17):** Peak communication window for pitching and teamwork.
4. **Luteal (Days 18-28):** Independent work phase; focus on stabilizing blood sugar.
